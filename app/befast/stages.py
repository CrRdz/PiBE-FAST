...
PROMPTS = {
    ...
    "ready_arms": "Sit down and show both shoulders, elbows, wrists, and hips.",
    "arms": "Follow the prompted single-arm forward/back or side-to-side movement.",
    "retry_arms": "Show the full upper body and repeat all four reach phases.",
